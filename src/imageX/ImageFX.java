...
public class ImageFX {
     ...
     * 
     */
    public ImageFX(int width, int height){
        this.width = width;
        this.height = height;
    ...
    /**
     * This method will threshold the image.
     ...
     */
    public void thresholdImageGrayscale(int thresholdValue){
        for(int y = 0; y < height; y++){
            for(int x = 0; x < width; x++){
                int r = getRed(x,y);
                int g = getGreen(x,y);
                ...
                if(thresholdValue > avgPixelValue){
                    setPixel(x,y,255,255,255,255);  //set WHITE
                }else{
                    setPixel(x,y,255,0,0,0);  //set BLACK
                }
            }
        }
    }
